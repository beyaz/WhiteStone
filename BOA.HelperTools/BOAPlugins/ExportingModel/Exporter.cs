...
namespace BOAPlugins.ExportingModel
{
    class Exporter
    {
        ...
        {
            var data = JsonHelper.Deserialize<ExportContract>(File.ReadAllText(configFilePath));
            Export(data);
            return data;
        }
        ...
        static void Export(ExportContract data)
        {
