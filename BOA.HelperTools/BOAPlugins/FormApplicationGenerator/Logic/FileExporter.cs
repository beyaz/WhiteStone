...
namespace BOAPlugins.FormApplicationGenerator.Logic
{
    class FileExporter
    {
        ...
        public void ExportFiles()
        {
            ...
            Util.WriteFileIfContentNotEqual(Model.ListFormTsxFilePath, Model.ToBrowsePageTemplate().TransformText());
            Util.WriteFileIfContentNotEqual(Model.DetailFormTsxFilePath, Model.ToTransactionPageTemplate().TransformText());
