...
namespace RavSoft.GoogleTranslator
{
    ...
    public class Translator : RavSoft.WebResourceProvider
    {
        ...
        {
            string url = string.Format("http://translate.google.com/?sl={0}&tl={1}&ie=UTF-8&oe=UTF-8&q={2}",
            ...
            protected override void parseContent()
            {
                ...
                var indexOf_TRANSLATED_TEXT = this.Content.IndexOf("TRANSLATED_TEXT='");
                indexOf_TRANSLATED_TEXT += "TRANSLATED_TEXT='".Length;

                var indexOf_TRANSLATED_TEXT2 = this.Content.IndexOf( "'", indexOf_TRANSLATED_TEXT);
