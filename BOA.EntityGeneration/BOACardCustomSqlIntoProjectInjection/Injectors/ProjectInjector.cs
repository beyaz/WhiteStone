...
namespace BOA.EntityGeneration.BOACardCustomSqlIntoProjectInjection.Injectors
{
    ...
    public class ProjectInjector
    {
        ...
        void Inject(ProjectCustomSqlInfo data)
        {
            ...
            {
                var typesFilePath = $@"D:\work\BOA.CardModules\Dev\AutoGeneratedCodes\{data.ProfileId}\BOA.Types.Dal.{data.ProfileId}\All.cs";
                var businessFilePath = $@"D:\work\BOA.CardModules\Dev\AutoGeneratedCodes\{data.ProfileId}\BOA.Types.Dal.{data.ProfileId}\All.cs";
